...
const Notifications = () => {
    ...
    const changedNotifications=notifications.map((n)=>{
    ...
    console.log("changed",changedNotifications)
  return (
    <div className="notifications">
      ...
      {open ? (<div className="notifications-box">
      <div className="notifications-header">
        ...
        {changedNotifications?.length === 0 ? <span className="notification">No notifications yet ...</span> : null}
        {changedNotifications && changedNotifications.map((n,index)=>{
          return (
          <div key={index} className={n.isRead ? "notification" : "notification not-read"} onClick={()=>{markAsRead(n,userChats,user,notifications); setOpen(false)}}>
